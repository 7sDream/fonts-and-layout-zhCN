...
#let summary = [
  ...
  - #chapter("chapters/03-unicode/unicode.typ")[Unicode 标准]
    - #chapter(
        "chapters/03-unicode/global-scripts.typ",
      )[Unicode中的#tr[global scripts]]
    ...
    - #chapter(
        "chapters/03-unicode/norm-decomp.typ",
      )[#tr[normalization]和#tr[decompose]]
  ...
  - #chapter("chapters/04-opentype/opentype.typ")[OpenType 的工作原理]
    ...
    - #chapter(
        "chapters/04-opentype/fonttools-ttx.typ",
      )[FontTools 和 `ttx` 工具]
    - #chapter(
        "chapters/04-opentype/exploring/exploring.typ",
      )[借助 `ttx` 探索 OpenType 字体]
      - #chapter("chapters/04-opentype/exploring/head.typ")[`head` 表]
      - #chapter(
          "chapters/04-opentype/exploring/hhea-os2.typ",
    ...
    - #chapter(
        "chapters/04-opentype/ttf-outline.typ",
  ...
  - #chapter("chapters/05-features/features.typ")[OpenType特性简介]
    ...
    - #chapter(
        "chapters/05-features/ligature.typ",
    ...
    - #chapter(
        "chapters/05-features/shaping/shaping.typ",
      )[文本#tr[shaping]的工作流程]
  ...
  - #chapter(
      "chapters/06-features-2/features-2.typ",
    )[#tr[substitution]和#tr[positioning]规则]
    - #chapter(
        "chapters/06-features-2/substitution/substitution.typ",
      )[各种类型的#tr[substitution]规则]
      - #chapter(
          "chapters/06-features-2/substitution/multiple.typ",
        )[#tr[multiple substitution]]
      - #chapter(
          "chapters/06-features-2/substitution/alternate.typ",
        )[#tr[alternate substitution]]
      - #chapter(
          "chapters/06-features-2/substitution/ligature.typ",
        )[#tr[ligature]#tr[substitution]]
      - #chapter(
          "chapters/06-features-2/substitution/chaining.typ",
        )[#tr[chaining substitution]]
      - #chapter(
          "chapters/06-features-2/substitution/extension.typ",
        )[扩展#tr[substitution]]
      - #chapter(
          "chapters/06-features-2/substitution/rev-chaining.typ",
        )[逆向#tr[chaining]#tr[substitution]]
    - #chapter(
        "chapters/06-features-2/positioning/positioning.typ",
      )[各种类型的#tr[positioning]规则]
      - #chapter(
          "chapters/06-features-2/positioning/single.typ",
        )[#tr[single adjustment]]
      - #chapter("chapters/06-features-2/positioning/pair.typ")[字偶对调整]
      - #chapter(
          "chapters/06-features-2/positioning/cursive.typ",
        )[#tr[cursive attachment]]
    - #chapter(
        "chapters/06-features-2/anchor/anchor.typ",
      )[#tr[anchor attachment]]
      - #chapter("chapters/06-features-2/anchor/mark.typ")[符号#tr[positioning]]
      - #chapter(
          "chapters/06-features-2/anchor/ligature-mark.typ",
        )[#tr[ligature]上的符号]
      - #chapter("chapters/06-features-2/anchor/mark-to-mark.typ")[符号叠放]
      - #chapter(
          "chapters/06-features-2/anchor/chaining.typ",
        )[#tr[chaining]#tr[positioning]]
    - #chapter(
        "chapters/06-features-2/checking.typ",
      )[使用 `hb-shape` 检查#tr[positioning]规则]
  - #chapter(
      "chapters/07-localisation/localisation.typ",
    )[服务#tr[global scripts]的OpenType]
    - #chapter("chapters/07-localisation/practice.typ")[特性实践]
    - #chapter(
        "chapters/07-localisation/lang-spec.typ",
      )[特定语言专属#tr[substitution]]
    - #chapter("chapters/07-localisation/letter-i.typ")[麻烦的字母 i]
    - #chapter(
        "chapters/07-localisation/arabic-urdu-sindhi.typ",
      )[阿拉伯语、乌尔都语、信德语]
    - #chapter(
        "chapters/07-localisation/other-scripts.typ",
      )[其他复杂#tr[scripts]]
  ...
  - #chapter(
      "chapters/13-harfbuzz/harfbuzz.typ",
