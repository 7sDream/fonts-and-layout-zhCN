...
#let graph = with-unit((ux, uy) => {
  ...
  shape((180, 256), (191, 326), (228, 328), (218, 257), closed: true, stroke: 1 * ux + black)
  txt([部件 #thai[\u{0E19}] 的锚点], (150, 290), anchor: "rc", size: 20 * ux)
  bezier((150, 290), (170, 290), none, (185, 279), stroke: 2 * ux + black)
  arrow-head((185, 279), 8, theta: -40deg, point-at-center: true)

  point((422, 273), radius: 5, color: gray)
  shape((400, 255), (410, 327), (448, 329), (438, 257), closed: true, stroke: 1 * ux + black)
  txt([部件 #thai[\u{0E15}] 的锚点], (380, 297), anchor: "rc", size: 20 * ux)
  bezier((380, 297), (400, 297), none, (410, 285), stroke: 2 * ux + black)
